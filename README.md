...
It has a few key differences from existing coding agents, some of which are listed here:
 ...
 - Plan mode is clearly separated from build mode, and in plan mode, models create plans as reviewable artifacts rather than just outputting a wall of text once.
